...
urlpatterns = [
    ...
    url(r'^data/yearly/findings$', views.data_yearly_findings, name='data_yearly_findings'),

    url(r'^data/yearly/bl$', views.data_yearly_bl, name='data_yearly_bl'),
    url(r'^data/yearly/bl/(?P<year>\d+)/findings$', views.data_yearly_bl, {'type': 'findings'}, name='data_yearly_bl'),
    url(r'^data/yearly/bl/(?P<year>\d+)/observations$', views.data_yearly_bl, {'type': 'observations'}, name='data_yearly_bl_observations'),  # observations
    ...
    # per bl
    url(r'^data/quarterly/(?P<business_line>[\w\s]+)/variation$', views.data_finding_variation, name='data_finding_variation'),
