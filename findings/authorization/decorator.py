...
from findings.authorization import AuthorizationManager
...
def tree_authorization(fields=None, tree_model='findings.BusinessLine', owner_field=None, owner_permission=None):
    def set_meta(cls):
        if not hasattr(cls, '_authorization_meta'):
