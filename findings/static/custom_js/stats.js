...
function generate_table(selector, url) {
	$.getJSON(url, function(data) {
		...
		$.each(data, function(key, finding) {
			tr = $('<tr />');
			tr.append("<td>"+moment(finding.date, 'YYYY-MM-DD HH:mm').format('YYYY-MM-DD HH:mm')+"</td>");
			tr.append("<td>"+finding.id+"</td>");
			tr.append("<td>"+finding.subject+"</td>");
			tr.append("<td>"+finding.category+"</td>");
			tr.append("<td>"+finding.confidentiality_display+"</td>");
			tr.append("<td><span class='badge threatcon-"+finding.severity+"'>"+finding.severity+"</span></td>");
			tr.append("<td>"+finding.business_lines_names+"</td>");
			tr.append("<td>"+finding.status_display+"</td>");
			tr.append("<td>"+finding.detection+"</td>");
			tr.append("<td>"+finding.actor+"</td>");
			tr.append("<td>"+finding.last_comment_action+"</td>");
			tr.append("<td>"+finding.opened_by+"</td>");
			tr.append("<td>"+finding.plan+"</td>");
			table.append(tr);
		});
	});
}
